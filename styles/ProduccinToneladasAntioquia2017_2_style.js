...
var style_ProduccinToneladasAntioquia2017_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value > 32.000000 && value <= 1000.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 10000.000000 && value <= 16400.000000) {
            style = [ new ol.style.Style({
